                ...
                <table role="presentation" width="560" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding:28px 32px;color:#33414f;font-size:14px;line-height:1.7;">
                            <p style="margin:0;">Poštovani/a <?php echo e($contactMessage->name); ?>,</p>
                            ...
                            <p style="margin:24px 0 0;">Srdačan pozdrav,<br><?php echo e(config('app.name')); ?></p>
                        </td>
                    </tr>
                </table>
            </td>
...
<?php /**PATH /var/www/html/site-core/resources/views/emails/contact_confirmation.blade.php ENDPATH**/ ?>